...
class MemberDAOTest {
  ...
  /** */
  @Test
  void testInsertMembers00() throws Exception {
  ...
  void testInsertMembers01() {
    try (SqlSession sqlSession = sqlSessionFactory().openSession()) {
      ...
      sqlSession.insert(MemberMapper.class.getCanonicalName().concat(".insertMember"), vo0);
      sqlSession.insert(MemberMapper.class.getCanonicalName().concat(".insertMember"), vo1);
