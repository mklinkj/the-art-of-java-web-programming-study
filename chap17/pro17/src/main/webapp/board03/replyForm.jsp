...
<body>
<h1 class="text-center mt-4 mb-4">답글 쓰기</h1>

<div class="card d-flex justify-content-center mx-auto col-9">
  <div class="card-body ">
    <form method="post" action="${contextPath}/board4/addReply.do" enctype="multipart/form-data">
      <div class="row mb-3">
      ...
      <div class="d-flex justify-content-center">
        ...
        <a href="${contextPath}/board4/viewArticle.do?articleNo=${parentNo}">
